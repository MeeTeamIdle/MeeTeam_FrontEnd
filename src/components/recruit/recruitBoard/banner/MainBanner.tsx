...
const MainBanner = () => {
	return (
		<S.Banner>
			...
			<section>
				<img
					src='meeteam_banner_icon_xlarge.png'
					srcSet='meeteam_banner_icon_small.webp 600w,  meeteam_banner_icon_medium.webp 900w, meeteam_banner_icon_xlarge.png 1980w'
